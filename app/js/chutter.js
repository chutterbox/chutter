(function() {
  ...
  app = angular.module('Chutter', ['ui.router', 'ngMaterial', 'templates-shared', 'ng-token-auth', 'ngResource', 'emguo.poller', 'hc.marked', 'angularMoment', 'angularytics']).constant('API', {
